...
pub type RXTX = crate::Reg<u32, _RXTX>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _RXTX;
...
pub type TXFULL = crate::Reg<u32, _TXFULL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _TXFULL;
...
pub type RXEMPTY = crate::Reg<u32, _RXEMPTY>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _RXEMPTY;
...
pub type TXEMPTY = crate::Reg<u32, _TXEMPTY>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _TXEMPTY;
#[doc = "`read()` method returns [txempty::R](txempty::R) reader structure"]
impl crate::Readable for TXEMPTY {}
#[doc = ""]
pub mod txempty;
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rxfull](rxfull) module"]
pub type RXFULL = crate::Reg<u32, _RXFULL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _RXFULL;
#[doc = "`read()` method returns [rxfull::R](rxfull::R) reader structure"]
impl crate::Readable for RXFULL {}
#[doc = ""]
pub mod rxfull;
